...
#pragma warning restore CS0169 // The field 'Bank.CC' is never used
        ...
        //**************************************************************************************************************************//
        {
            ...
            /*            Customer.CustNoChangedEvent += Bank_CustNoChangedEvent1;
                        Customer.CustListChangedEvent += Bank_CustListChangedEvent;
        ...
        */
...

        {
            ...
            if ( CheckNormal.Checked )
            {
                ...
                BankAccount.CreateNewBankAccount ( bank, accno, ( Int16 ) 1, ( decimal ) 237.18, ( decimal ) 3.72 );
