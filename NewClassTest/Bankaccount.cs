...
{
    [Serializable]
    public class BankAccount : IDisposable, IComparable<BankAccount>, Interface1
    {
        ...
        public string FullInfo
        {
            get
            {
                return $"{BankAccountNumber} {CustAccountNumber} ({Balance})";
            }
        }
        ...
        public int CompareTo(BankAccount bank)
        {
            ...
            if (Compare(bank, this))
                return 1;
            else
                return -1;
        }
        public static bool Compare(BankAccount a, BankAccount b)
        {
            if (Bank._badirection == 0)
                return (a.BankAccountNumber < b.BankAccountNumber);
            else
                return (a.BankAccountNumber > b.BankAccountNumber);
        }
