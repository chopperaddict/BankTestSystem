		...
		//*************************************************************************************************************//
		{
			...
			*/
			...
			if ( Cust != null )
			{
				...
				if ( index == -1 )
				{
					MessageBox.Show("This Customer account details cannot be found in ArrayList...,",
						"Customer FULL Edit facility");
					return;
				}
				...
				if ( indx == -1 )
				{
					MessageBox.Show("This Bank  account details cannot be found in ArrayList...,",
						"Customer FULL Edit facility");
					return;
				}
				...
				try
				{
					...
					BankAccount.BankDict.Remove(indx);
				...
				{
					MessageBox.Show(
						"This Bank  account details cannot be updated , Data system is NOW inconsistent !...,",
						"Customer FULL Edit facility");
					return;
				}
