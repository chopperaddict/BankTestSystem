...
{
	[Serializable]
	public class Customer : IComparable<Customer>, IComparer<Customer> //IDisposable,
	{
		...
		//****************************************************************************************************************************
		{
			CustNoChangedEvent += Customer_CustNoChangedEvent;
			CustListChangedEvent += Customer_CustListChangedEvent;
		...
		//this.Dispose();;GC.SuppressFinalize (this);}
							...
							string addr2, string town, string County, string Postcode, int actype, Int32 bAccountNo, DateTime DOB )
		{
			...
			string str = GetCustFilePath ( ) + fnamealone;
...
#pragma DICTTODO
		...
		public static void WriteCustObjectToDiskAndText ( Customer Cust, string FileName )
		{
			...
			if (Cust.accounttypes[3] > 0)
				...
				accts += ",";
			string s = Cust.CustomerNumber + "," + Cust.FirstName + "," + Cust.LastName + "," + Cust.Address1 + "," +
					   Cust.Address2 + "," + Cust.Town + "," + Cust.County + ","
					   + Cust.PostCode + "," + Cust.PhoneNumber + "," + Cust.MobileNumber + "," + Cust.DOB.ToString ( ) +
					   "," + Cust.FileName + "," + accts + ",\r\n";
